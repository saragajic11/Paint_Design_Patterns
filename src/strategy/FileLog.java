		...
		try {
			...
			if (command != null && command.length() != 0) {
				...
				case "BringToBack":
					...
					i = model.getIndexOf(bringToBackShape);
					doCommand = new CmdBringToBack(model.get(i), model);
					if (commandOperation[1].equals("EXECUTE")) {
						controller.doCommand(doCommand);
				...
				case "BringToFront":
					...
					doCommand = new CmdBringToFront(model.get(i), model, model.getAll().size() - 1);
					if (commandOperation[1].equals("EXECUTE")) {
						controller.doCommand(doCommand);
				...
				case "ToBack":
					...
					doCommand = new CmdToBack(model.get(i), model);
					if (commandOperation[1].equals("EXECUTE")) {
						controller.doCommand(doCommand);
				...
				case "ToFront":
					...
					doCommand = new CmdToFront(model.get(i), model);
					if (commandOperation[1].equals("EXECUTE")) {
						controller.doCommand(doCommand);
				...
				case "UPDATEPOINT":
					...
					if (commandOperation[1].equals("EXECUTE")) {
						i = model.getIndexOf(oldShape);
						doCommand = new CmdUpdatePoint((Point) model.get(i), (Point) newShape);
						controller.doCommand(doCommand);
				...
				case "UPDATELINE":
					...
					if (commandOperation[1].equals("EXECUTE")) {
						...
						doCommand = new CmdUpdateLine((Line) model.get(i), (Line) newLine);
						controller.doCommand(doCommand);
				...
				case "UPDATEREC":
					...
					if (commandOperation[1].equals("EXECUTE")) {
						...
						doCommand = new CmdUpdateRectangle((Rectangle) model.get(i), (Rectangle) newRec);
						controller.doCommand(doCommand);
				...
				case "UPDATESQUARE":
					...
					if (commandOperation[1].equals("EXECUTE")) {
						...
						doCommand = new CmdUpdateSquare((Square) model.get(i), (Square) newSquare);
						controller.doCommand(doCommand);
				...
				case "UPDATECIRCLE":
					...
					if (commandOperation[1].equals("EXECUTE")) {
						...
						doCommand = new CmdUpdateCircle((Circle) model.get(i), (Circle) newCircle);
						controller.doCommand(doCommand);
				...
				case "UPDATEHEX":
					...
					if (commandOperation[1].equals("EXECUTE")) {
						...
						doCommand = new CmdUpdateHexagon((HexagonAdapter) model.get(i), (HexagonAdapter) newHex);
						controller.doCommand(doCommand);
